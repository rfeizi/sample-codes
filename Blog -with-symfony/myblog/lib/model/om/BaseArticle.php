...
abstract class BaseArticle extends BaseObject  implements Persistent {
	...
	public function setTag($v)
	{
		...
		if ($this->tag !== $v) {
			$this->tag = $v;
			$this->modifiedColumns[] = ArticlePeer::TAG;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = ArticlePeer::NUM_COLUMNS - ArticlePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArticlePeer::TAG)) $criteria->add(ArticlePeer::TAG, $this->tag);
