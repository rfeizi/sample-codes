...
abstract class BaseCommentPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'articleId', 'author', 'content', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ARTICLE_ID, self::AUTHOR, self::CONTENT, self::CREATED_AT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'articleId' => 1, 'author' => 2, 'content' => 3, 'createdAt' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ARTICLE_ID => 1, self::AUTHOR => 2, self::CONTENT => 3, self::CREATED_AT => 4, ),
	...
	public static function doCountJoinArticle(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(CommentPeer::ARTICLE_ID, ArticlePeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Comment objects pre-filled with their Article objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinArticle(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Comment) to $obj2 (Article)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Comment) to the collection in $obj2 (Article)
				$obj2->addComment($obj1);
